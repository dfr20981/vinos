...
<body >
          ...
          <nav class="navbar navbar-expand-lg navbar-dark fixed-top bgcolor1">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto" style="margin-right: 20%;">
                ...
                <li class="nav-item active" >
                  <a class="nav-link" href="../login/login.php" id="text1">BIENVENIDO</a>
                </li>
                <li class="nav-item active" >
                  <a class="nav-link" href="../registro/registro.php" id="text1">REGISTRO</a>
                </li>
              </ul>
            </div>
             <a class="nav-link" href="#" id="text3">La <span id="buena">buena</span> copa</a>
            <a  href="#"  >
              <img src="img/logo_labuenacopa.png" width="70" height="70" class="d-inline-block align-top" alt="" loading="lazy" >
            </a>
          </nav>
        </div>
        <br>
        <br>
        <center><h1 id="TituloMapa">La Ruta del Vino</h1></center>
        <br>
  ...
  <script src="js/oper.js" type="text/javascript"></script>
