...
<meta charset="utf-8">
<head>
    <title>View Carritot - PHP Shopping Cart Tutorial</title>
    <meta charset="utf-8">
...
<ul class="nav nav-pills">
  <li role="presentation"><a href="vinostienda.php">Inicio</a></li>
  <li role="presentation" class="active"><a href="VerCarta.php">Ver carrot</a></li>
...
<div class="panel-body">
    ...
    <tbody>
        ...
        <?php } }else{ ?>
        <tr><td colspan="5"><p>Tu Carrito esta vasio.....</p></td>
        <?php } ?>
    </tbody>
    <tfoot>
        <tr>
            <td><a href="vinostienda.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Continue Comprando</a></td>
            <td colspan="2"></td>
