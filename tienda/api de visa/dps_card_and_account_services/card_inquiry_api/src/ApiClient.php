...
class ApiClient
{
     ...
     */
    public function __construct(\dcas_100\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \dcas_100\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($path, $resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\dcas_100\ObjectSerializer::sanitizeForSerialization($postData));
        }
