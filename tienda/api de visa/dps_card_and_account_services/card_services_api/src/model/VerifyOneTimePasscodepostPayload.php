...
/**
 * VerifyOneTimePasscodepostPayload Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class VerifyOneTimePasscodepostPayload implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'verifyOneTimePasscodepostPayload';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['verification_code'] === null) {
            $invalid_properties[] = "'verification_code' can't be null";
        }
     ...
     * @param string $verification_code The onetime verification code.
     * @return $this
     */
