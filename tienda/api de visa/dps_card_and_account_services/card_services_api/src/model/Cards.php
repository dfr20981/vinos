 ...
 *
 * @category    Class
 * @description Provides an array of cardIds with card status, accounts and their balances.
 * @package     dcas_101
...
class Cards implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'accounts' => '\dcas_101\model\Accounts',
        'pan' => 'string',
        'card_id' => 'string'
    ];
    ...
    /**
     * Gets accounts
     * @return \dcas_101\model\Accounts
     */
    ...
    /**
     * Sets accounts
     * @param \dcas_101\model\Accounts $accounts
     * @return $this
     */
