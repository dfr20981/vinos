...
```php
    require_once('/path/to/prod_6/ads_100/autoload.php');
```
...
------------ | ------------- | ------------- | -------------
*AdjustmentApi* | [**postadjustreversefunds**](docs/Api/AdjustmentApi.md#postadjustreversefunds) | **POST** /visadirect/v1/adjustment | 


## Documentation For Models

 - [Address](docs/Model/Address.md)
 - [AdjustreversefundspostPayload](docs/Model/AdjustreversefundspostPayload.md)
 - [AdjustreversefundspostResponse](docs/Model/AdjustreversefundspostResponse.md)
