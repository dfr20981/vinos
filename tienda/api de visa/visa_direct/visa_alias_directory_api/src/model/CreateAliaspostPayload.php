...
/**
 * CreateAliaspostPayload Class Doc Comment
 *
 * @category    Class
 * @description Request body for creating alias API
 * @package     alias_100
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateAliaspostPayload implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateAliaspostPayload';
     ...
     * @param string $consent_date_time Date & time when consumer has provided their consent to Issuer about the use of their personal personal data for VAD service. Format: YYYY-MM-DD hh:mm:ss.  Local date and time should be converted to Coordinated Universal Time (UTC) before submitting this value in API request.
     * @return $this
     */
    ...
    /**
     * Sets card_type
     * @param string $card_type Card type description. Reference to Field 62.23—Product ID of available card products. e.g. Visa Platinum
     * @return $this
     */
     ...
     * @param string $recipient_last_name Consumer’s last name.
     * @return $this
     */
    ...
    /**
     * Sets country
     * @param string $country Consumer’s country code as defined by ISO 3166, ISO 3166 alpha-2 is recommended to be used if alias may be used for QR.
     * @return $this
     */
    ...
    /**
     * Sets postal_code
     * @param string $postal_code Postal/Zip code of the consumer.
     * @return $this
     */
    ...
    /**
     * Sets guid
     * @param string $guid This attribute is uniquely used by Issuer to identify their customer (i.e. consumer cardholder).<br>Issuer may pass their existing unique identifier of a cardholder of their system to VAD as a guid.<br>For multiple aliases linked to the same PAN, different guids should be provided.
     * @return $this
     */
