 ...
 *
 * @category    Class
 * @description Merchandise Return Response
 * @package     mvrf_100
...
class MerchandiseReturnPostpostResponse implements ArrayAccess
{
    ...
    /**
     * Sets response_code
     * @param string $response_code The source for the response; typically, either the recipient issuer or a Visa system.          The VisaNet Response Source for the transaction
     * @return $this
     */
