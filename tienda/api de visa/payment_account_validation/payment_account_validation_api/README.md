...
```php
    require_once('/path/to/prod_9/cv_100/autoload.php');
```
...
------------ | ------------- | ------------- | -------------
*PavApi* | [**postcardvalidation**](docs/Api/PavApi.md#postcardvalidation) | **POST** /pav/v1/cardvalidation | 


## Documentation For Models

 - [CardvalidationpostPayload](docs/Model/CardvalidationpostPayload.md)
 - [CardvalidationpostResponse](docs/Model/CardvalidationpostResponse.md)
