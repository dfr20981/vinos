...
/**
 * CancelPaymentpostPayload Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     vpa_102
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CancelPaymentpostPayload implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'cancelPaymentpostPayload';
     ...
     * @param string $original_message_id The messageId of the original process payment request that is being canceled.
     * @return $this
     */
    ...
    /**
     * Sets cancel_reason
     * @param string $cancel_reason Contains the reason for canceling the payment.
     * @return $this
     */
