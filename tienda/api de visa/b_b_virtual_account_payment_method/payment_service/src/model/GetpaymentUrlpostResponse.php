...
/**
 * GetpaymentUrlpostResponse Class Doc Comment
 *
 * @category    Class
 * @description Success
 * @package     vpa_102
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetpaymentUrlpostResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'getpaymentUrlpostResponse';
    ...
    /**
     * Sets url
     * @param string $url URL for the credential verification application which will authenticate the user before presenting the payment details.
     * @return $this
     */
