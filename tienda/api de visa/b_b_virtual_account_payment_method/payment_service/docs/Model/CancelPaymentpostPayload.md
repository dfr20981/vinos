# CancelPaymentpostPayload

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**original_message_id** | **string** | The messageId of the original process payment request that is being canceled. | 
...
**cancel_reason** | **string** | Contains the reason for canceling the payment. | [optional] 
