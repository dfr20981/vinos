# GetsupplierDetailspostResponse
...
**supplier_country_code** | **string** | Supplier country code. It is alphanumeric.VPA supports all ISO alpha numeric country code.For example- USA. | 
**security_answers** | [**\vpa_101\model\SecurityAnswers**](SecurityAnswers.md) |  | [optional] 
**supplier_type** | **string** | Type of supplier. Valid values are ● VPA ● STP | 
**stp_id** | **int** | STP ID to be associated with supplier of type STP. Format- 0–9. STPID is required new STP suppliers.  You can get the STPID for the supplier you want to pay using the supplier matching service | [optional] 
...
**account_details** | [**\vpa_101\model\AccountDetails**](AccountDetails.md) |  | [optional] 
...
**supplier_address_line1** | **string** | Supplier address line 1. | 
...
**supplier_id** | **string** | Identifier used by the buyer to identify the supplier in VPA system. | 
