...
/**
 * GetsupplierDetailspostResponse Class Doc Comment
 *
 * @category    Class
 * @description OK
 * @package     vpa_101
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetsupplierDetailspostResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'getsupplierDetailspostResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'account_details' => '\vpa_101\model\AccountDetails',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['supplier_language'] === null) {
            $invalid_properties[] = "'supplier_language' can't be null";
        }
        if ($this->container['supplier_country_code'] === null) {
            $invalid_properties[] = "'supplier_country_code' can't be null";
        }
        if ($this->container['supplier_type'] === null) {
            $invalid_properties[] = "'supplier_type' can't be null";
        }
        if ($this->container['status_desc'] === null) {
            $invalid_properties[] = "'status_desc' can't be null";
        }
        if ($this->container['supplier_address_line1'] === null) {
            $invalid_properties[] = "'supplier_address_line1' can't be null";
        }
        ...
        if ($this->container['supplier_city'] === null) {
            $invalid_properties[] = "'supplier_city' can't be null";
        }
    ...
    /**
     * Sets stp_id
     * @param int $stp_id STP ID to be associated with supplier of type STP. Format- 0–9. STPID is required new STP suppliers.  You can get the STPID for the supplier you want to pay using the supplier matching service
     * @return $this
     */
     ...
     * @return \vpa_101\model\AccountDetails
     */
     ...
     * @param \vpa_101\model\AccountDetails $account_details
     * @return $this
     */
    ...
    /**
     * Sets supplier_id
     * @param string $supplier_id Identifier used by the buyer to identify the supplier in VPA system.
     * @return $this
     */
