...
```php
    require_once('/path/to/prod_15/ml_100/autoload.php');
```
...
use \ml_100\Configuration;
    ...
    //Set all the required parameters in the postmerchantLocator. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*Merchant_locatorApi* | [**postmerchantLocator**](docs/Api/Merchant_locatorApi.md#postmerchantlocator) | **POST** /merchantlocator/v1/locator | 


## Documentation For Models

 - [Header](docs/Model/Header.md)
 - [MerchantLocatorpostPayload](docs/Model/MerchantLocatorpostPayload.md)
 - [MerchantLocatorpostResponse](docs/Model/MerchantLocatorpostResponse.md)
 - [Response](docs/Model/Response.md)
 - [ResponseHeader](docs/Model/ResponseHeader.md)
 - [ResponseValues](docs/Model/ResponseValues.md)
 - [SearchAttrList](docs/Model/SearchAttrList.md)
