...
/**
 * MerchantBenchmarkpostResponse Class Doc Comment
 *
 * @category    Class
 * @description Merchant Benchmark Response payload
 * @package     mb_100
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MerchantBenchmarkpostResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'merchantBenchmarkpostResponse';
    ...
    protected static $swaggerTypes = [
        'status' => '\mb_100\model\Status',
        'response_header' => '\mb_100\model\ResponseHeader',
        'response' => '\mb_100\model\Response'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['response_header'] === null) {
            $invalid_properties[] = "'response_header' can't be null";
        }
    ...
    /**
     * Sets status
     * @param \mb_100\model\Status $status
     * @return $this
     */
     ...
     * @return \mb_100\model\ResponseHeader
     */
     ...
     * @param \mb_100\model\ResponseHeader $response_header
     * @return $this
     */
    ...
    /**
     * Sets response
     * @param \mb_100\model\Response $response
     * @return $this
     */
