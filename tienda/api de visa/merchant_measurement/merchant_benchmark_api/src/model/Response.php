...
class Response implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'response_data' => '\mb_100\model\ResponseData'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['response_data'] === null) {
            $invalid_properties[] = "'response_data' can't be null";
        }
    ...
    /**
     * Gets response_data
     * @return \mb_100\model\ResponseData
     */
    ...
    /**
     * Sets response_data
     * @param \mb_100\model\ResponseData $response_data
     * @return $this
     */
