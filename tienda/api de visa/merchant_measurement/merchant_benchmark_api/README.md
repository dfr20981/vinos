...
```php
    require_once('/path/to/prod_21/mb_100/autoload.php');
```
...
use \mb_100\Configuration;
    ...
    //Set all the required parameters in the postmerchantBenchmark. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*Merchant_benchmarkApi* | [**postmerchantBenchmark**](docs/Api/Merchant_benchmarkApi.md#postmerchantbenchmark) | **POST** /merchantmeasurement/v1/merchantbenchmark | 


## Documentation For Models

 - [MerchantBenchmarkpostPayload](docs/Model/MerchantBenchmarkpostPayload.md)
 - [MerchantBenchmarkpostResponse](docs/Model/MerchantBenchmarkpostResponse.md)
