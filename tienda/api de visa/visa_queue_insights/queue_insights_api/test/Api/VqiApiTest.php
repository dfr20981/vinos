...
use \vqi_100\api\VqiApi;

/**
 * VqiApiTest Class Doc Comment
 *
 * @category Class
 * @package  vqi_100
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VqiApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test case for postvqiService
     *
     * .
     *
     */
    public function testPostvqiService()
    {
        echo "\nMaking a call to PostvqiService()\n";

        $api_instance = new VqiApi;
        $result = $api_instance->PostvqiService($this->transformPayload('{"requestData":{"kind":"predict"},"requestHeader":{"messageDateTime":"2017-09-13T20:57:12.327","requestMessageId":"6da60e1b8b024532a2e0eacb1af58581"}}'));
