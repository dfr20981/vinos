...
class RequestData implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'feedback_list' => '\vqi_100\model\FeedbackList',
        'kind' => 'string'
    ];
    ...
    {
        $this->container['feedback_list'] = isset($data['feedback_list']) ? $data['feedback_list'] : null;
    ...
    /**
     * Gets feedback_list
     * @return \vqi_100\model\FeedbackList
     */
    ...
    /**
     * Sets feedback_list
     * @param \vqi_100\model\FeedbackList $feedback_list
     * @return $this
     */
    ...
    /**
     * Sets kind
     * @param string $kind Whether the request is for prediction or feedback, Can only take values: 'predict', 'feedback'
     * @return $this
     */
