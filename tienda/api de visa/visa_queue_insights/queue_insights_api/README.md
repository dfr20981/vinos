...
```php
    require_once('/path/to/prod_37/vqi_100/autoload.php');
```
...
use \vqi_100\Configuration;
    ...
    //Set all the required parameters in the postvqiService. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*VqiApi* | [**postvqiService**](docs/Api/VqiApi.md#postvqiservice) | **POST** /visaqueueinsights/v1/queueinsights | 


## Documentation For Models

 - [FeedbackList](docs/Model/FeedbackList.md)
 - [FeedbackListInner](docs/Model/FeedbackListInner.md)
 - [FeedbackUpdateList](docs/Model/FeedbackUpdateList.md)
 - [FeedbackUpdateListInner](docs/Model/FeedbackUpdateListInner.md)
 - [MerchantList](docs/Model/MerchantList.md)
 - [MerchantListInner](docs/Model/MerchantListInner.md)
 - [RequestData](docs/Model/RequestData.md)
 ...
 - [VqiServicepostPayload](docs/Model/VqiServicepostPayload.md)
 - [VqiServicepostResponse](docs/Model/VqiServicepostResponse.md)
