...
use \vnds_100\api\CountryCodeLookupApi;

/**
 * CountryCodeLookupApiTest Class Doc Comment
 *
 * @category Class
 * @package  vnds_100
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CountryCodeLookupApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test case for postcountryCodeLookup
     *
     * .
     *
     */
    public function testPostcountryCodeLookup()
    {
        echo "\nMaking a call to PostcountryCodeLookup()\n";

        $api_instance = new CountryCodeLookupApi;
        $result = $api_instance->PostcountryCodeLookup($this->transformPayload('{"requestData":{"partialLookup":"Y","countryName":"","countryAlphaCode":"","countryCode":"840"},"requestHeader":{"messageDateTime":"2018-01-15T01:02:31.327Z","requestMessageId":"6da60e1b8b024532a2e0eacb1af58581"}}'));
