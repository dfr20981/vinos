...
```php
    require_once('/path/to/prod_51/vnds_100/autoload.php');
```
...
use \vnds_100\Configuration;
    ...
    //Set all the required parameters in the postcountryCodeLookup. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*CountryCodeLookupApi* | [**postcountryCodeLookup**](docs/Api/CountryCodeLookupApi.md#postcountrycodelookup) | **POST** /visanetdataservice/getCountryCodeLookup | 


## Documentation For Models

 - [CountryCodeLookuppostPayload](docs/Model/CountryCodeLookuppostPayload.md)
 - [CountryCodeLookuppostResponse](docs/Model/CountryCodeLookuppostResponse.md)
