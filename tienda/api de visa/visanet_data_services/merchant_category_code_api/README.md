...
```php
    require_once('/path/to/prod_51/vnds_102/autoload.php');
```
...
use \vnds_102\Configuration;
    ...
    //Set all the required parameters in the postmccCodeLookup. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*MccCodeLookupApi* | [**postmccCodeLookup**](docs/Api/MccCodeLookupApi.md#postmcccodelookup) | **POST** /visanetdataservice/getMccCodeLookup | 


## Documentation For Models

 - [MccCodeLookuppostPayload](docs/Model/MccCodeLookuppostPayload.md)
 - [MccCodeLookuppostResponse](docs/Model/MccCodeLookuppostResponse.md)
