...
use \vnds_102\api\MccCodeLookupApi;

/**
 * MccCodeLookupApiTest Class Doc Comment
 *
 * @category Class
 * @package  vnds_102
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MccCodeLookupApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test case for postmccCodeLookup
     *
     * .
     *
     */
    public function testPostmccCodeLookup()
    {
        echo "\nMaking a call to PostmccCodeLookup()\n";

        $api_instance = new MccCodeLookupApi;
        $result = $api_instance->PostmccCodeLookup($this->transformPayload('{"requestData":{"partialLookup":"Y","merchantCategoryCode":"5812"},"requestHeader":{"messageDateTime":"2018-06-08 18:43:55.439","requestMessageId":"Test001"}}'));
