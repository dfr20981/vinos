...
```php
    require_once('/path/to/prod_51/vnds_103/autoload.php');
```
...
use \vnds_103\Configuration;
    ...
    //Set all the required parameters in the posttransactionCodeLookup. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*TransactionCodeLookupApi* | [**posttransactionCodeLookup**](docs/Api/TransactionCodeLookupApi.md#posttransactioncodelookup) | **POST** /visanetdataservice/getTransactionCodeLookup | 
...
## Documentation For Models
 ...
 - [TransactionCodeLookuppostPayload](docs/Model/TransactionCodeLookuppostPayload.md)
 - [TransactionCodeLookuppostResponse](docs/Model/TransactionCodeLookuppostResponse.md)
