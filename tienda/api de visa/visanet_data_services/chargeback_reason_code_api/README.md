...
```php
    require_once('/path/to/prod_51/vnds_104/autoload.php');
```
...
use \vnds_104\Configuration;
    ...
    //Set all the required parameters in the postchargebackReasonCodeLookup. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*ChargebackReasonCodeLookupApi* | [**postchargebackReasonCodeLookup**](docs/Api/ChargebackReasonCodeLookupApi.md#postchargebackreasoncodelookup) | **POST** /visanetdataservice/getChargebackReasonCodeLookup | 


## Documentation For Models

 - [ChargebackReasonCodeLookuppostPayload](docs/Model/ChargebackReasonCodeLookuppostPayload.md)
 - [ChargebackReasonCodeLookuppostResponse](docs/Model/ChargebackReasonCodeLookuppostResponse.md)
