...
use \vnds_101\api\CurrencyCodeLookupApi;

/**
 * CurrencyCodeLookupApiTest Class Doc Comment
 *
 * @category Class
 * @package  vnds_101
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CurrencyCodeLookupApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test case for postcurrencyCodeLookup
     *
     * .
     *
     */
    public function testPostcurrencyCodeLookup()
    {
        echo "\nMaking a call to PostcurrencyCodeLookup()\n";

        $api_instance = new CurrencyCodeLookupApi;
        $result = $api_instance->PostcurrencyCodeLookup($this->transformPayload('{"requestData":{"countryAlphaCode":"","countryCode":"US","partialLookup":"Y","currencyCode":"","countryName":"","currencyAplhaCode":"","currencyName":""},"requestHeader":{"messageDateTime":"","requestMessageId":"MBGlobe"}}'));
