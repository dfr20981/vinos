...
```php
    require_once('/path/to/prod_51/vnds_101/autoload.php');
```
...
use \vnds_101\Configuration;
    ...
    //Set all the required parameters in the postcurrencyCodeLookup. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*CurrencyCodeLookupApi* | [**postcurrencyCodeLookup**](docs/Api/CurrencyCodeLookupApi.md#postcurrencycodelookup) | **POST** /visanetdataservice/getCurrencyCodeLookup | 


## Documentation For Models

 - [CurrencyCodeLookuppostPayload](docs/Model/CurrencyCodeLookuppostPayload.md)
 - [CurrencyCodeLookuppostResponse](docs/Model/CurrencyCodeLookuppostResponse.md)
