...
```php
    require_once('/path/to/prod_27/vces_101/autoload.php');
```
...
use \vces_101\Configuration;
    ...
    //Set all the required parameters in the postgetValiadationStatus. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*Visa_card_eligibility_iframeApi* | [**postgetValiadationStatus**](docs/Api/Visa_card_eligibility_iframeApi.md#postgetvaliadationstatus) | **POST** /visacardeligibilityservices/v1/eligibility/validateresult | 
*Visa_card_eligibility_iframeApi* | [**postredeemOfferViaIframe**](docs/Api/Visa_card_eligibility_iframeApi.md#postredeemofferviaiframe) | **POST** /visacardeligibilityservices/v1/promo/iframeredemption | 
*Visa_card_eligibility_iframeApi* | [**postregisterIframe**](docs/Api/Visa_card_eligibility_iframeApi.md#postregisteriframe) | **POST** /visacardeligibilityservices/v1/registeriframe/token | 


## Documentation For Models

 - [GetValiadationStatuspostPayload](docs/Model/GetValiadationStatuspostPayload.md)
 - [GetValiadationStatuspostResponse](docs/Model/GetValiadationStatuspostResponse.md)
 - [RedeemOfferViaIframepostPayload](docs/Model/RedeemOfferViaIframepostPayload.md)
 - [RedeemOfferViaIframepostResponse](docs/Model/RedeemOfferViaIframepostResponse.md)
 - [RegisterIframepostPayload](docs/Model/RegisterIframepostPayload.md)
 - [RegisterIframepostResponse](docs/Model/RegisterIframepostResponse.md)
 - [RegisteriFrameResponse](docs/Model/RegisteriFrameResponse.md)
 - [ValidationResultResponse](docs/Model/ValidationResultResponse.md)
