...
/**
 * PrepaypostResponse Class Doc Comment
 *
 * @category    Class
 * @description Prepay card
 * @package     vces_100
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PrepaypostResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'prepaypostResponse';
    ...
    protected static $setters = [
        ...
        'has_pan_matched' => 'setHasPanMatched',
    ...
    protected static $getters = [
        ...
        'has_pan_matched' => 'getHasPanMatched',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['has_pan_matched'] = isset($data['has_pan_matched']) ? $data['has_pan_matched'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['has_pan_matched'] === null) {
            $invalid_properties[] = "'has_pan_matched' can't be null";
        }
     ...
     * @param string $status_description Status of the request
     * @return $this
     */
    ...
    /**
     * Gets has_pan_matched
     * @return string
     */
    public function getHasPanMatched()
    {
        return $this->container['has_pan_matched'];
    }

    /**
     * Sets has_pan_matched
     * @param string $has_pan_matched Returns the information that same card is used for validation and pre-payment
     * @return $this
     */
    public function setHasPanMatched($has_pan_matched)
    {
        $this->container['has_pan_matched'] = $has_pan_matched;
    ...
    /**
     * Sets correlation_id
     * @param string $correlation_id CorrelationId
     * @return $this
     */
