...
```php
    require_once('/path/to/prod_27/vces_100/autoload.php');
```
...
use \vces_100\Configuration;
    ...
    //Set all the required parameters in the postprepay. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*Visa_card_eligibility_serviceApi* | [**postprepay**](docs/Api/Visa_card_eligibility_serviceApi.md#postprepay) | **POST** /visacardeligibilityservices/v1/cardeligibility/prepay | 
*Visa_card_eligibility_serviceApi* | [**postredeemOffer**](docs/Api/Visa_card_eligibility_serviceApi.md#postredeemoffer) | **POST** /visacardeligibilityservices/v1/promo/redeem | 
*Visa_card_eligibility_serviceApi* | [**postvalidateCardEligibility**](docs/Api/Visa_card_eligibility_serviceApi.md#postvalidatecardeligibility) | **POST** /visacardeligibilityservices/v1/cardeligibility/validate | 


## Documentation For Models

 - [CardBenefits](docs/Model/CardBenefits.md)
 - [CardBenefitsInner](docs/Model/CardBenefitsInner.md)
 - [ExpirationDate](docs/Model/ExpirationDate.md)
 - [PrepaypostPayload](docs/Model/PrepaypostPayload.md)
 - [PrepaypostResponse](docs/Model/PrepaypostResponse.md)
 - [RedeemOfferpostPayload](docs/Model/RedeemOfferpostPayload.md)
 - [RedeemOfferpostResponse](docs/Model/RedeemOfferpostResponse.md)
 - [ValidateCardEligibilitypostPayload](docs/Model/ValidateCardEligibilitypostPayload.md)
 - [ValidateCardEligibilitypostResponse](docs/Model/ValidateCardEligibilitypostResponse.md)
