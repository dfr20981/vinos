...
use \tns_100\api\Travel_notificationApi;

/**
 * Travel_notificationApiTest Class Doc Comment
 *
 * @category Class
 * @package  tns_100
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Travel_notificationApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        echo '\n.................Testing Travel_notificationApi...........................\n';
    }
    ...
    /**
     * Test case for deletedeleteTravel
     *
     * .
     *
     */
    public function testDeletedeleteTravel()
    {
        echo "\nMaking a call to DeletedeleteTravel()\n";

        $api_instance = new Travel_notificationApi;
        $result = $api_instance->DeletedeleteTravel($this->transformPayload('{"deleteTravelItinerary":{"travelItineraryId":"2313"}}'));
    ...
    /**
     * Test case for postretrieveTravel
     *
     * .
     *
     */
    public function testPostretrieveTravel()
    {
        echo "\nMaking a call to PostretrieveTravel()\n";

        $api_instance = new Travel_notificationApi;
        $result = $api_instance->PostretrieveTravel($this->transformPayload('{"retrieveTravelItinerary":{"primaryAccountNumber":{"cardAccountNumber":"4645191800301234"},"toDate":"2017-05-21","fromDate":"2017-03-21","partnerBid":"10074101"}}'));
