...
```php
    require_once('/path/to/prod_17/tns_100/autoload.php');
```
...
use \tns_100\Configuration;
    ...
    //Set all the required parameters in the deletedeleteTravel. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*Travel_notificationApi* | [**deletedeleteTravel**](docs/Api/Travel_notificationApi.md#deletedeletetravel) | **DELETE** /travelnotificationservice/v1/travelnotification/itinerary | 
*Travel_notificationApi* | [**postretrieveTravel**](docs/Api/Travel_notificationApi.md#postretrievetravel) | **POST** /travelnotificationservice/v1/travelnotification/retrievetravel | 


## Documentation For Models

 - [AddTravelpostPayload](docs/Model/AddTravelpostPayload.md)
 - [AddTravelpostResponse](docs/Model/AddTravelpostResponse.md)
 - [DeleteTraveldeletePayload](docs/Model/DeleteTraveldeletePayload.md)
 - [DeleteTraveldeleteResponse](docs/Model/DeleteTraveldeleteResponse.md)
 - [Destinations](docs/Model/Destinations.md)
 - [PrimaryAccountNumber](docs/Model/PrimaryAccountNumber.md)
 - [PrimaryAccountNumbers](docs/Model/PrimaryAccountNumbers.md)
 - [RetrieveTravelItinerary](docs/Model/RetrieveTravelItinerary.md)
 - [RetrieveTravelpostPayload](docs/Model/RetrieveTravelpostPayload.md)
 - [RetrieveTravelpostResponse](docs/Model/RetrieveTravelpostResponse.md)
 - [TravelItinerary](docs/Model/TravelItinerary.md)
 - [UpdateTravelputPayload](docs/Model/UpdateTravelputPayload.md)
 - [UpdateTravelputResponse](docs/Model/UpdateTravelputResponse.md)
