...
```php
    require_once('/path/to/prod_30/sms_101/autoload.php');
```
...
use \sms_101\Configuration;
    ...
    //Set all the required parameters in the getdownload. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*Sms_searchApi* | [**getdownload**](docs/Api/Sms_searchApi.md#getdownload) | **GET** /visasuppliermatchingservice/v1/download | 
*Sms_searchApi* | [**getstatus**](docs/Api/Sms_searchApi.md#getstatus) | **GET** /visasuppliermatchingservice/v1/status | 
*Sms_searchApi* | [**postupload**](docs/Api/Sms_searchApi.md#postupload) | **POST** /visasuppliermatchingservice/v1/upload | 


## Documentation For Models

 - [BulkMatchResponse](docs/Model/BulkMatchResponse.md)
 - [DownloadgetResponse](docs/Model/DownloadgetResponse.md)
 - [Status](docs/Model/Status.md)
 - [StatusgetResponse](docs/Model/StatusgetResponse.md)
 - [UploadpostResponse](docs/Model/UploadpostResponse.md)
