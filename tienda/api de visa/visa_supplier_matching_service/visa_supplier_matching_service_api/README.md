...
```php
    require_once('/path/to/prod_30/sms_100/autoload.php');
```
...
use \sms_100\Configuration;
    ...
    //Set all the required parameters in the postsmsSearch. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*Supplier_matching_serviceApi* | [**postsmsSearch**](docs/Api/Supplier_matching_serviceApi.md#postsmssearch) | **POST** /visasuppliermatchingservice/v1/search?supplierName&#x3D;supplier1&amp;supplierCountryCode&#x3D;840 | 


## Documentation For Models

 - [MatchDetails](docs/Model/MatchDetails.md)
 - [SmsSearchpostResponse](docs/Model/SmsSearchpostResponse.md)
