<?php
/**
 * Supplier_matching_serviceApiTest
 * PHP version 5
 *
 * @category Class
 * @package  sms_100
...
use \sms_100\api\Supplier_matching_serviceApi;

/**
 * Supplier_matching_serviceApiTest Class Doc Comment
 *
 * @category Class
 * @package  sms_100
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Supplier_matching_serviceApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        echo '\n.................Testing Supplier_matching_serviceApi...........................\n';
    }
    ...
    /**
     * Test case for postsmsSearch
     *
     * .
     *
     */
    public function testPostsmsSearch()
    {
        echo "\nMaking a call to PostsmsSearch()\n";

        $api_instance = new Supplier_matching_serviceApi;
        $result = $api_instance->PostsmsSearch($this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'), $this->addRandom('random'));
