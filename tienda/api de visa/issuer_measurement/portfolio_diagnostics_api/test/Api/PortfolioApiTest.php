 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PortfolioApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test case for postportfolioDiagnostics
     *
     * .
     *
     */
    public function testPostportfolioDiagnostics()
    {
        echo "\nMaking a call to PostportfolioDiagnostics()\n";

        $api_instance = new PortfolioApi;
        $result = $api_instance->PostportfolioDiagnostics($this->transformPayload('{"requestData":{"month":"201607","currency":"USD","product":["G","K1","S","A","B","C","D","G3"],"accountFundingSource":"C","country":"840"},"requestHeader":{"messageDateTime":"2016-01-15T01:02:31.327Z","requestMessageId":"6da60e1b8b024532a2e0eacb1af58581"}}'));
