...
```php
    require_once('/path/to/prod_29/im_100/autoload.php');
```
...
use \im_100\Configuration;
    ...
    //Set all the required parameters in the postportfolioDiagnostics. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*PortfolioApi* | [**postportfolioDiagnostics**](docs/Api/PortfolioApi.md#postportfoliodiagnostics) | **POST** /issuermeasurement/v1/portfoliodiagnostics | 


## Documentation For Models

 - [PortfolioDiagnosticspostPayload](docs/Model/PortfolioDiagnosticspostPayload.md)
 - [PortfolioDiagnosticspostResponse](docs/Model/PortfolioDiagnosticspostResponse.md)
