...
```php
    require_once('/path/to/prod_16/ms_100/autoload.php');
```
...
use \ms_100\Configuration;
    ...
    //Set all the required parameters in the postmerchantSearch. Look at the documentation for further clarification.
...
------------ | ------------- | ------------- | -------------
*Merchant_searchApi* | [**postmerchantSearch**](docs/Api/Merchant_searchApi.md#postmerchantsearch) | **POST** /merchantsearch/v1/search | 


## Documentation For Models

 - [Header](docs/Model/Header.md)
 - [MerchantSearchpostPayload](docs/Model/MerchantSearchpostPayload.md)
 - [MerchantSearchpostResponse](docs/Model/MerchantSearchpostResponse.md)
