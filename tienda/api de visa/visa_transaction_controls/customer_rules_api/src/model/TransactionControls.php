 ...
 *
 * @category    Class
 * @description If provided, includes the list of defined Transaction Controls that have been configured for the card.
 * @package     pmc_100
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TransactionControls implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'transactionControls';
