...
/**
 * MerchantTypeControlsCardInquirypostPayload Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MerchantTypeControlsCardInquirypostPayload implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'merchantTypeControlsCardInquirypostPayload';
     ...
     * @param string $primary_account_number The card number for which the control details are to be returned, must be between 16 and 19
     * @return $this
     */
