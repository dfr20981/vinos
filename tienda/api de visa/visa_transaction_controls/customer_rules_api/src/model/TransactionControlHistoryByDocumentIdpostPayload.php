...
/**
 * TransactionControlHistoryByDocumentIdpostPayload Class Doc Comment
 *
 * @category    Class
 * @description request
 * @package     pmc_100
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TransactionControlHistoryByDocumentIdpostPayload implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'transactionControlHistoryByDocumentIdpostPayload';
     ...
     * @param string $primary_account_number The card number for which the control details are to be returned.
     * @return $this
     */
    ...
    /**
     * Sets start_date
     * @param string $start_date The start date (yyyy-mm-dd) from which the transaction controls documents have to be returned.
     * @return $this
     */
    ...
    /**
     * Sets end_date
     * @param string $end_date The end date (yyyy-mm-dd) from which the transaction controls documents have to be returned
     * @return $this
     */
