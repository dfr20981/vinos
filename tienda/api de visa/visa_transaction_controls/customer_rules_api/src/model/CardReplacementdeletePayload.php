...
/**
 * CardReplacementdeletePayload Class Doc Comment
 *
 * @category    Class
 * @description request
 * @package     pmc_100
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CardReplacementdeletePayload implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'cardReplacementdeletePayload';
     ...
     * @param string $primary_account_number The primary account number must be between 16 and 19
     * @return $this
     */
