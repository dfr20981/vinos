...
/**
 * CustomerAlertsProfilepatchPayload Class Doc Comment
 *
 * @category    Class
 * @description request
 * @package     pmc_105
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CustomerAlertsProfilepatchPayload implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'customerAlertsProfilepatchPayload';
     ...
     * @param bool $is_profile_active This flag determines whether the customer profile can be used to for last mile alerts.
     * @return $this
     */
